...
Interactive visualization of classical pathfinding algorithms on weighted grids.

**Tech:** Python · Pygame · A* · BFS · DFS

* 40×40 weighted grid
* Terrain with different movement costs
* Procedural maze generation
* Path carving
* Live pathfinding analytics
* Node exploration and path-cost visualization
...
**Tech:** Python · Scikit-learn · Random Forest · MLP · SMOTE
